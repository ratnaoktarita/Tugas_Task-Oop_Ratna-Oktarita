 ...
 */
fun myProfile() {
    val firstName: String = "Ratna"
    val lastName: String = "Oktarita"
    val age: Int = 21
...
fun main() {
    val anggotaTeam = listOf<String>(
        "Ratna Oktarita",
        "Wulan Ayu Febriani",
        "M Dzaki Roid yunitra",
        "A S Jamalludin Zuhdi",
        "Fyga Khourunisa",
        "Michael Owen Rangngan",
        "Djaya Pamungkas",
        "Silviana Anggellica",
        "Yudiansyah",
        "Amelinda Anastasia",
     ...
     *
     */
    groupDetail("Posesive", listOf(), "Morning")
